...
import graphicscontrollers.NotificationViewController;
...
public class NotificationView implements View {
    ...
    private void animate() {
        StackPane parent = (StackPane) views.ViewNavigator.getActiveView().getRoot();
        ...
        slideIn.setToY(views.ViewNavigator.getStage().getHeight()/25);
        slideIn.play();
